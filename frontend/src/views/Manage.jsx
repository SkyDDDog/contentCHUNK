...
import { WechatOutlined, TikTokOutlined } from '@ant-design/icons';
...
export default function Manage() {
  return (
    <>
      ...
      <SimpleGrid spacing={'13%'} templateColumns='repeat(auto-fill, minmax(200px, 1fr))' backgroundColor={'#cecece'}>
        <Card>
          <CardHeader>
            <Heading size='md'>
              <WechatOutlined /> &nbsp;&nbsp;微信公众号
