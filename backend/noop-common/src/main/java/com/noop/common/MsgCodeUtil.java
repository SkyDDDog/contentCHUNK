...
public class MsgCodeUtil {
    ...
    public static final int MSG_CODE_SYSTEM_ROLE_NAME_EXIST = -10011;
    ...
    public static final int MSG_CODE_JWT_PERMISSION_LIMITED = -10014;
    ...
    public static String getIllegalArgumentMessage(List<FieldError> fieldErrors) {
